...
public class JwtTokenGenerator {
    ...
    public String generateAccessToken(Authentication authentication) {
        ...
        String permissions = getPermissionFromRoles(roles);
    ...
    private String getPermissionFromRoles(String roles){
        ...
        if (roles.contains("ROLE_MODERATOR")){
            permissions.addAll(List.of("READ", "MOD_WRITE", "MOD_DELETE"));
            //permissions.add("READ");
        }
        if (roles.contains("ROLE_USER")){
            permissions.addAll(List.of("READ", "USER_WRITE", "USER_DELETE"));
            //permissions.add("READ");
        }
